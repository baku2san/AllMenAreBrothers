...
### フェーズ2: ゲームプレイ（進行中）
- ✅ 戦闘システム（高度な戦闘・地形効果・一騎討ち）
- ✅ 英雄育成システム（レベルアップ・スキル習得・経験値）
- ✅ 外交システム（同盟・貿易・関係値管理）
- ✅ セーブ/ロード機能
- 🔄 イベントシステム（拡張中）
...
水滸伝の世界観に基づいた本格的な英雄成長システムを実装：

#### 経験値・レベルアップ
- **戦闘経験値**: 戦闘参加で自動獲得（戦績により変動）
- **訓練システム**: 資金を消費して任意の経験値獲得
- **レベル上限**: 各英雄最大100レベルまで成長可能
- **レベルアップ演出**: スキル習得とステータス向上の通知

#### スキル習得システム
- **職業別スキル**: 武将・軍師・政治家・外交官・斥候の5職業
- **段階的習得**: レベル5・10・15・20で新スキル獲得
- **特殊効果**: 戦闘力向上・内政効率アップ・外交成功率向上

#### 英雄管理UI
- **仲間一覧**: 現在の仲間英雄のステータス確認
- **育成画面**: 経験値ゲージ・レベル・習得スキル表示
- **装備管理**: 武器・防具・アクセサリの装備変更（今後拡張）

#### 戦闘への影響
- **パフォーマンス評価**: 戦闘での活躍度を4段階で評価
- **経験値獲得**: 戦績に応じて10-100の経験値獲得
- **負傷システム**: 敗北時の負傷判定とペナルティ
